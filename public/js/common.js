$(document).ready(function(){ 
    ...
    $('.medicine_quantity').keyup(function () {
   var quantity=$(this).text();
   var price=$(this).closest('td').prev('td').text();
   var totalPrice=price*quantity;
   $(this).closest('td').next('td').text(totalPrice)
    ...
    * */
    ...
    $(function () { //invoice management
        ...
        function addnewrow(addnewrowkey) {
            ...
            + '<td width="10%">' +  '<input type="text" name="product_id" class="form-control productid" required >' + '</td>'
                 + '<td width="10%">' +'<input type="text" name="product_name" class="form-control productname" required >' + '</td>'
                 + '<td width="10%">' + '<input type="text" name="type" class="form-control type" required >' + '</td>'
                 + '<td width="10%">' + '<input type="date" name="exp_date[]" class="form-control expdate" required >' + '</td>'
